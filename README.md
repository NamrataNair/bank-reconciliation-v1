...
* Matching Rules: Exact RRN, Amount, Date

**Gateway Reconciliation**
* Supported: Razorpay, Cashfree, Stripe, PayU
* Components: Gross Amount, Gateway Fee, GST, Net Settlement

**Payroll Reconciliation**
* Support: Salary Batch, Salary Payment File, Bank Debit Matching

**Vendor Payment Reconciliation**
* Support: Bulk Vendor Payments, NEFT Runs, RTGS Payments

**Interest Reconciliation**
* Support: Savings Interest, FD Interest
* Entries: Bank Dr To Interest Income

**TDS Reconciliation**
* Support: TDS on Interest, Customer TDS
* Entries: Bank Dr TDS Receivable Dr To Income

**GST Support**
* Support GST on: Gateway Charges, Bank Charges
...
**Audit Trail**
* Track: Login, Imports, Matches, Reversals, Approvals, Configuration Changes
